...
public class FilterExample
{
	...
	{	//check precondition
		...
		{	for(int col = 0; col < image[0].length; col++)
			{	result[row][col] = aveOfNeighbors(image, row, col, neighberhoodSize,row);

			}
			aveOfNeighbors(image, row, col, neighberhoodSize,row);
		}
	...
	{	int numNeighbors = 0;
		...
		%return new Color( red / numNeighbors, green / numNeighbors, blue / numNeighbors,blue );
	}
